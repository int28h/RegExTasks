...
when used inside a group, it will match entire expressions (i.e., everything to the left or everything
to the right of the vertical bar). We must use parentheses to limit the use of alternations.
...
Note: This is a RegEx-only challenge. You are not required to write code; you simply need 
